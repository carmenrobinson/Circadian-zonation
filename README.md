This is a personal branch and fork for work on the code published in Droin et al. (2021). All credit and ownership goes to the authors (text below from the original repository).
